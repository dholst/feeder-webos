  ...
  activate: function($super, changes) {
    ...
    this.controller.serviceRequest('palm://com.palm.systemservice/time', {
      ...
      onSuccess: function(response) {
        if((this.credentials.service !== "ttrss" && this.credentials.email && this.credentials.password) || (this.credentials.service === "ttrss" && this.credentials.email && this.credentials.password && this.credentials.server) || this.credentials.service === "feedly") {
          if(this.triedLogin) {
